...
classes =["zCubwf","hgKElc","LITKOO sY7ric","Z0Lcw","gsrt vk_bk FzvwSb YwPhnf","pclqee","tw-Data-text-small tw-ta",
          "IZ6rdc","O5uR6d","LTKOO","vlzY6d","webanswers-webanswers_table_webanswer-table","dDoNo ikb4Bb gsrt","sXLaOe",
...
def OpenApp(app, sess=requests.session()):
    try:
        ...
        # Popular apps and their web URLs
        official_urls = {
        ...
        url = official_urls.get(app_lower)
...
if __name__ == "__main__":
    asyncio.run(Automation(["open youtube","open ideogram","open leonardoAI"]))